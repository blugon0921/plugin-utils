...
fun Translatable.translate() : TranslatableComponent {
...
fun TextComponent.rgbColor(rgb: Triple<Int, Int, Int>): TextComponent = this.color(TextColor.color(TextColor.color(rgb.first, rgb.second, rgb.third)))